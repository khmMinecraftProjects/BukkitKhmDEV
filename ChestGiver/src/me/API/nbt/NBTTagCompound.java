...
public class NBTTagCompound extends NBTBase
{
    ...
    /**
     * Stores a new NBTTagStringArray with the given string value into the map with the given string key.
     */
    public void setStringArray(String par1Str, String[] par2Str)
    {
        this.tagMap.put(par1Str, new NBTTagStringArray(par1Str, par2Str));
    }
     ...
     * Retrieves a string value using the specified key, or an empty string if no such key was stored.
     */
    public String[] getStringArray(String par1Str)
    {
        try
        {
            return !this.tagMap.containsKey(par1Str) ? null : ((NBTTagStringArray)this.tagMap.get(par1Str)).Array;
        }
        catch (ClassCastException classcastexception)
        {
            //throw new ReportedException(this.createCrashReport(par1Str, 8, classcastexception));
